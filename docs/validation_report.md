...
本报告验证 v0.2.0 的纯 Python 逻辑、接口、解耦性和本机 CPU 开销。未使用远程 GPU，因此不包含 TE 2.7.0/Megatron 真实训练吞吐或 Nsight 精度对照。
...
| 公共包导入 | 通过 |
| wheel 构建与隔离安装 | `overlap_monitor_v2-0.2.0-py3-none-any.whl` 通过 |
