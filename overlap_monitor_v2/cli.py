...
from overlap_monitor_v2.analyzer.critical_path import CriticalPathOverlapAnalyzer
...
from overlap_monitor_v2.visualization.ascii_timeline import render_ascii_timeline
from overlap_monitor_v2.visualization.chrome_trace import write_chrome_trace
from overlap_monitor_v2.visualization.summary_table import render_summary_table


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="overlap-monitor-v2",
