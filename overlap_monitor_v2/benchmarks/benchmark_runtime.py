...
from overlap_monitor_v2.analyzer import OverlapAnalyzer
from overlap_monitor_v2.core.events import Event, EventType
from overlap_monitor_v2.profiler import WorkHandleRecorder
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="CPU microbenchmark for overlap_monitor_v2")
